<?php
        ...
        $sql1 = "select * from upload_labler where id = '$_POST[lable]'";
        ...
        if($_POST['mod_name'] != ''){
            echo "<meta http-equiv='Content-Type' content='text/html; charset=UTF-8' />
                  <script>window.location.href='../user/alter_name.php?id=".$_POST[mod_name]."';</script>";
        }
        if($row1['labler_count'] >= 3){
            if(have_($row1['labler'], $login['username']) == false){
            echo "<meta http-equiv='Content-Type' content='text/html; charset=UTF-8' />
                  <script>alert('该病人标注已完成，请选择其他病人！'); history.go(-1);</script>";
            exit();
            }
        }
        function have_($str1,$str2){
            preg_match_all("/$str2/sim",$str1,$strResult,PREG_PATTERN_ORDER);
            return !empty($strResult[0]);
        }

        //查询标注后的数据
        if($_POST[check_lable] != null){
            if(have_($row1['labler'], $login['username'])){
                echo "<meta http-equiv='Content-Type' content='text/html; charset=UTF-8' />
                  <script>
                     if(confirm('您已标注过此病人,是否要进行修改？')){
                             window.location.href='update_lable.php?id=".$_POST[lable]."';
                           }else{
                             history.go(-1);
                           }
                  </script>";
            ...
            echo "<meta http-equiv='Content-Type' content='text/html; charset=UTF-8' />
                          <script>window.location.href='check_lable.php?userid=".$_POST[check_lable]."';</script>";
            exit();
        }
                            ...
                            <div class="box-tools m-b-15">
 							...
 							<form action="submit_lable.php" enctype="multipart/form-data" method="post">
                                <table class="table table-hover">
                                  ...
                                  <tbody>
                                <?php
                                    $sql = "select * from photo_video where id = '$_POST[lable]'"; //SQL语句
                                    ...
                                    <tr>
                                      ...
                                      <th>额纹对称情况：
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic1" value="0" checked> 正常
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic1" value="1"> 轻度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic1" value="2"> 中度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic1" value="3"> 重度
                                              </label><br>
										     眼睑开合情况：
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic2" value="0" checked> 正常
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic2" value="1"> 轻度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic2" value="2"> 中度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic2" value="3"> 重度
                                              </label><br>
                                                                                                          鼻唇沟深浅程度：
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic3" value="0" checked> 正常
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic3" value="1"> 轻度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic3" value="2"> 中度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic3" value="3"> 重度
                                              </label><br>
                                                                                                           嘴角歪斜的程度：
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic4" value="0" checked> 正常
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic4" value="1"> 轻度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic4" value="2"> 中度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="userstatic4" value="3"> 重度
                                              </label><br>
                                      </th>
                                    </tr>
                                    <tr>
                                      ...
                                      <th>
                                                                                                      额肌运动的异常程度：
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="taimei" value="0" checked> 正常
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="taimei" value="1"> 轻度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="taimei" value="2"> 中度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="taimei" value="3"> 重度
                                              </label>
                                      </th>
                                    </tr>
                                    <tr>
                                      ...
                                      <th>
										    皱眉肌运动的异常程度：
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="zhoumei" value="0" checked> 正常
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="zhoumei" value="1"> 轻度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="zhoumei" value="2"> 中度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="zhoumei" value="3"> 重度
                                              </label>
                                      </th>
                                    </tr>
                                    <tr>
                                      ...
                                      <th>
                                      	    眼睑开合的异常程度：
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="biyan" value="0" checked> 正常
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="biyan" value="1"> 轻度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="biyan" value="2"> 中度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="biyan" value="3"> 重度
                                              </label>
                                      </th>
                                    </tr>
                                    <tr>
                                      ...
                                      <th>
                                      	     鼻唇沟异常程度：
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="songbi" value="0" checked> 正常
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="songbi" value="1"> 轻度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="songbi" value="2"> 中度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="songbi" value="3"> 重度
                                              </label>
                                      </th>
                                    </tr>
                                    <tr>
                                      ...
                                      <th>
                                       	    口角歪斜的异常程度：
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="weixiao" value="0" checked> 正常
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="weixiao" value="1"> 轻度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="weixiao" value="2"> 中度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="weixiao" value="3"> 重度
                                              </label>
                                      </th>
                                    </tr>
                                    <tr>
                                      ...
                                      <th>
                                      	    口角歪斜的异常程度：
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="shichi" value="0" checked> 正常
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="shichi" value="1"> 轻度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="shichi" value="2"> 中度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="shichi" value="3"> 重度
                                              </label>
                                      </th>
                                    </tr>
                                    <tr>
                                      ...
                                      <th>
                                      	    鼓腮漏气的情况：
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="gusai1" value="0" checked> 正常
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="gusai1" value="1"> 轻度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="gusai1" value="2"> 中度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="gusai1" value="3"> 重度
                                              </label><br>
                                                                                                        口角歪斜的程度：
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="gusai2" value="0" checked> 正常
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="gusai2" value="1"> 轻度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="gusai2" value="2"> 中度
                                              </label>
                                              <label class="checkbox-inline">
                                                  <input type="radio" name="gusai2" value="3"> 重度
                                              </label>
                                      </th>
                                    </tr>
                                  </tbody>
                                ...
                                <input type="hidden" name="lable" value="<?php echo $_POST["lable"];?>">
