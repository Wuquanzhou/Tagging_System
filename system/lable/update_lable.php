...
<!--                                 </li> -->
           ...
           <div class="row">
                      <?php
                          ...
                          $sql1 = "select * from upload_labler where id = '$_GET[id]'";
					  ...
					  <div class="col-md-8"  style="width:100%;">
                            ...
                            <div class="box-tools m-b-15">
 							...
 							<form action="lable_update.php" enctype="multipart/form-data" method="post">
                                ...
                                <?php
                                    ...
                                    $sql = "select * from photo_video where id = '$_GET[id]'"; //SQL语句
                                ...
                                <input type="hidden" name="lable" value="<?php echo $_GET["id"];?>">
                                <input type="submit" name="submit" style="width:3.5em;height:2em;" value="提交" class="btn btn-info" onclick="if(confirm('确认提交吗？')==false) return false;else window.location.href=('lable_update.php');"/>
                            </form>
                  </div>
              </div>
            </div><!--end col-6 -->
