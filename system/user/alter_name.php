                    ...
                    <div class="row">
					  <div class="col-md-8"  style="width:100%;">
                            ...
                            <div class="panel-body table-responsive">
                               <form action="mod_name.php" enctype="multipart/form-data" method="post"
                                    name="upload_file">
                                    <?php
                                        ...
                                        $sql = "select * from upload_labler where id = '$_GET[id]'";
                                        $result = mysql_query($sql);
                                        $row = mysql_fetch_array($result);
                                    ?>
                                    <label >患者姓名:</label>
                                    <input class="form-control" style="width:10em;height:1.9em;display: inline" type="text" name="username" value="<?php echo $row['name']?>"/><br><br>
                                    <label >性别:</label>
                                    <input class="form-control" style="width:10em;height:1.9em;display: inline" type="text" name="usersex" value="<?php echo $row['sex']?>"/><br><br>
                                    <label >年龄:</label>
                                    <input class="form-control" style="width:10em;height:1.9em;display: inline" type="text" name="userage" value="<?php echo $row['age']?>"/><br><br>
                                    <input type="hidden" name="lable" value="<?php echo $_GET["id"];?>">
                                    <input type="submit" class="btn btn-info" style="width:3.5em;height:2em;" name="submit" value="修改" onclick="if(confirm('确认修改吗？')==false) return false;else window.location.href=('mod_name.php');"/>
                           </form>
