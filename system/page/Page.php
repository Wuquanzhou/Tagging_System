...
class PageSupport{
    ...
    function standard_navigate()
    {
        ...
        echo "<form class=\"form-inline\" action=".$_SERVER['PHP_SELF']." method=\"get\">";

        echo "<font color = black size ='2'>第".$this->current_page."页/共".$this->total_pages."页</font>";
        echo "&nbsp&nbsp&nbsp";
        echo "跳到&nbsp<input type=\"text\" style=\"width:3.5em;height:2em;\" class=\"form-control\" name=\"current_page\" value='".$this->current_page."'/>&nbsp页";
        echo "&nbsp&nbsp&nbsp";
        echo "<input type=\"submit\" style=\"width:3.5em;height:2em;\" value=\"提交\" class=\"btn btn-info\"/>";
        echo "&nbsp&nbsp&nbsp";
